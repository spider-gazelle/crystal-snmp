...
describe SNMP::V3::Security do
  it "should init a security helper" do
    ...
    expect_raises(Exception) do
      sec = SNMP::V3::Security.new("steve", engine_id, auth_password: "123")
    end
  end
  ...
  it "should generate correct passkeys" do
    ...
    sec = SNMP::V3::Security.new("username", engine_id, SNMP::V3::Security::AuthProtocol::SHA, password, priv_password: "maplesyrup")
